...
$moxa_ip = "192.168.100.121"; // IP of the rs485/ip converter configured in Modbus TCP mode
$moxa_port = 502;
$moxa_timeout = 10;
$pause = 1000;
...
while(1)
{
        ...
        //                       TCP HEADER                                          ID      READ HOlding Registers                   ADDR      CRChi     CRClo
        ...
        $totalwatt_1 = round(hexToSignedDecimal(bin2hex(substr($byte,67,2)))*(0.1*20));
	  ...
	  echo "1_L3_AMPS: ".HexToUnsignedDecimal(bin2hex(substr($byte,39,2)))*(0.001*2)." A\n";
          ...
          echo "TOTAL_WATT: ".hexToSignedDecimal(bin2hex(substr($byte,67,2)))*(0.1*20)." W\n";
